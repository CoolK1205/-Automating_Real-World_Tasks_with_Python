...
if __name__ == "__main__":
    description_directory = '/home/student-04-5b621141c5eb/supplier-data/descriptions/' # The directory which contains all the files with data in it.
    ...
    msg = generate_email("automation@example.com", "student-04-5b621141c5eb@example.com",
